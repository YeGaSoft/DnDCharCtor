...
public class LocalizedRequiredAttribute(string fieldNameResourceKey) : RequiredAttribute
{
    ...
    protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
    {
        ...
        return new ValidationResult(string.Format(CultureInfo.CurrentCulture, StringResources.Validation_RequiredField, fieldName), [validationContext.MemberName ?? string.Empty]);
    }
}
